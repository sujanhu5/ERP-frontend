  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        target="_blank" rel="noopener noreferrer"
        className="p-2 rounded-full bg-white/[0.06] hover:bg-[#25D366]/20 text-white/60 hover:text-[#25D366] transition-all"
      ...
      <a
        href="https://www.instagram.com/maxmatrix.in?igsh=MWVpNXptb2prajhhOA=="
        target="_blank" rel="noopener noreferrer"
        className="p-2 rounded-full bg-white/[0.06] hover:bg-pink-500/20 text-white/60 hover:text-pink-400 transition-all"
